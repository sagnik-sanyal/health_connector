...
class _ExampleAppHomePageState extends State<ExampleAppHomePage> {
  ...
  /// Demonstrates [HealthConnectorHKClient.getHealthPlatformStatus] method.
  ///
  /// Checks if HealthKit is available, unavailable, or requires
  ...
  /// Demonstrates [HealthConnectorHKClient.deleteRecordsByIds] method.
  ///
