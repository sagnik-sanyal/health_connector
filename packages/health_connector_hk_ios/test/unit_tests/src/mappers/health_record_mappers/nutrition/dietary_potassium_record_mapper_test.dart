...
void main() {
  group('DietaryPotassiumRecordMapper', () {
    test(
      'toDto converts DietaryPotassiumRecord to DietaryPotassiumRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryPotassiumRecordDto to DietaryPotassiumRecord',
      () {
        final dto = DietaryPotassiumRecordDto(
