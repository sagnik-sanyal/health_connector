...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a MagnesiumNutrientRecordDto.
    ///
    /// - Returns: MagnesiumNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toMagnesiumNutrientDto() throws -> MagnesiumNutrientRecordDto {
...
extension MagnesiumNutrientRecordDto {
