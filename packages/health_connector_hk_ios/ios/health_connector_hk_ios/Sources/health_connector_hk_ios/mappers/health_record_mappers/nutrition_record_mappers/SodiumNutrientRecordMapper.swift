...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a SodiumNutrientRecordDto.
    ///
    /// - Returns: SodiumNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toSodiumNutrientDto() throws -> SodiumNutrientRecordDto {
...
extension SodiumNutrientRecordDto {
