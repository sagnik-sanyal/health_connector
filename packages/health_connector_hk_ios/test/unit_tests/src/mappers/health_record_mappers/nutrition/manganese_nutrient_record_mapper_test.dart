...
void main() {
  group('ManganeseNutrientRecordMapper', () {
    test(
      'toDto converts ManganeseNutrientRecord to ManganeseNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts ManganeseNutrientRecordDto to ManganeseNutrientRecord',
      () {
        final dto = ManganeseNutrientRecordDto(
