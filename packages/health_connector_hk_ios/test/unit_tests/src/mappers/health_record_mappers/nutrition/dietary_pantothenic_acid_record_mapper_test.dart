...
void main() {
  group('DietaryPantothenicAcidRecordMapper', () {
    test(
      'toDto converts DietaryPantothenicAcidRecord to '
    ...
    test(
      'toDomain converts DietaryPantothenicAcidRecordDto to '
      'DietaryPantothenicAcidRecord',
      () {
        final dto = DietaryPantothenicAcidRecordDto(
