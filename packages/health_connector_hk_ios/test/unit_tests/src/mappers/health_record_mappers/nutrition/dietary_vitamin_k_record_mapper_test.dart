...
void main() {
  group('DietaryVitaminKRecordMapper', () {
    test(
      'toDto converts DietaryVitaminKRecord to DietaryVitaminKRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryVitaminKRecordDto to DietaryVitaminKRecord',
      () {
        final dto = DietaryVitaminKRecordDto(
