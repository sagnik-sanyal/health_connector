...
void main() {
  group('RiboflavinNutrientRecordMapper', () {
    test(
      'toDto converts RiboflavinNutrientRecord to RiboflavinNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts RiboflavinNutrientRecordDto to '
      'RiboflavinNutrientRecord',
      () {
        final dto = RiboflavinNutrientRecordDto(
