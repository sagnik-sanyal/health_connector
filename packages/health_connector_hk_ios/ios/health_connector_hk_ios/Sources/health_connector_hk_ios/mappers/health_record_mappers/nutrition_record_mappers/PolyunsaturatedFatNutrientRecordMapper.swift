...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a PolyunsaturatedFatNutrientRecordDto.
    ///
    /// - Returns: PolyunsaturatedFatNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toPolyunsaturatedFatNutrientDto() throws -> PolyunsaturatedFatNutrientRecordDto {
        guard
...
extension PolyunsaturatedFatNutrientRecordDto {
