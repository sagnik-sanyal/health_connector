import 'package:health_connector_core/health_connector_core_internal.dart'
    show DietaryNiacinRecord, HealthRecordId, Mass, MealType, sinceV1_1_0;
...
import 'package:health_connector_hk_ios/src/pigeon/health_connector_hk_ios_api.g.dart'
    show DietaryNiacinRecordDto;
import 'package:meta/meta.dart' show internal;

/// Converts [DietaryNiacinRecord] to [DietaryNiacinRecordDto].
@sinceV1_1_0
@internal
extension DietaryNiacinRecordToDto on DietaryNiacinRecord {
  DietaryNiacinRecordDto toDto() {
...
/// Converts [DietaryNiacinRecordDto] to [DietaryNiacinRecord].
@sinceV1_1_0
@internal
