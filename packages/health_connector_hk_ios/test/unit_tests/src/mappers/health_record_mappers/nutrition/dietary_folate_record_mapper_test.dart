...
void main() {
  group('DietaryFolateRecordMapper', () {
    test('toDto converts DietaryFolateRecord to DietaryFolateRecordDto', () {
    ...
    test(
      'toDomain converts DietaryFolateRecordDto to DietaryFolateRecord',
      () {
        final dto = DietaryFolateRecordDto(
