...
void main() {
  group('DietaryCholesterolRecordMapper', () {
    test(
      'toDto converts DietaryCholesterolRecord to '
    ...
    test(
      'toDomain converts DietaryCholesterolRecordDto to '
      'DietaryCholesterolRecord',
      () {
        final dto = DietaryCholesterolRecordDto(
