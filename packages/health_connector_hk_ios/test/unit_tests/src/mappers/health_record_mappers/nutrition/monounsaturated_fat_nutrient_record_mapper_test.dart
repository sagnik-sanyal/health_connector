...
void main() {
  group('MonounsaturatedFatNutrientRecordMapper', () {
    test(
      'toDto converts MonounsaturatedFatNutrientRecord to '
    ...
    test(
      'toDomain converts MonounsaturatedFatNutrientRecordDto to '
      'MonounsaturatedFatNutrientRecord',
      () {
        final dto = MonounsaturatedFatNutrientRecordDto(
