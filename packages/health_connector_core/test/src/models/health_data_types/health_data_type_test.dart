  ...
  group('HealthDataType.id', () {
    parameterizedTest(
      ...
      [
        ...
        [HealthDataType.activityIntensity, 'activity_intensity'],
        [HealthDataType.alcoholicBeverages, 'alcoholic_beverages'],
        [HealthDataType.exerciseTime, 'apple_exercise_time'],
        [HealthDataType.moveTime, 'apple_move_time'],
        [HealthDataType.standTime, 'apple_stand_time'],
        [HealthDataType.walkingSteadiness, 'apple_walking_steadiness'],
        [HealthDataType.bloodAlcoholContent, 'blood_alcohol_content'],
        [HealthDataType.contraceptive, 'contraceptive'],
        [HealthDataType.elevationGained, 'elevation_gained'],
        [HealthDataType.forcedVitalCapacity, 'forced_vital_capacity'],
        [HealthDataType.highHeartRateEvent, 'high_heart_rate_event'],
        [
          HealthDataType.irregularHeartRhythmEvent,
          'irregular_heart_rhythm_event',
        ],
        [HealthDataType.lactation, 'lactation'],
        [HealthDataType.lowHeartRateEvent, 'low_heart_rate_event'],
        [HealthDataType.peripheralPerfusionIndex, 'peripheral_perfusion_index'],
        [
          HealthDataType.persistentIntermenstrualBleedingEvent,
          'persistent_intermenstrual_bleeding_event',
        ],
        [HealthDataType.pregnancy, 'pregnancy'],
        [HealthDataType.pregnancyTest, 'pregnancy_test'],
        [HealthDataType.progesteroneTest, 'progesterone_test'],
        [
          HealthDataType.prolongedMenstrualPeriodEvent,
          'prolonged_menstrual_period_event',
        ],
        [HealthDataType.runningPower, 'running_power'],
        [HealthDataType.sleepingWristTemperature, 'sleeping_wrist_temperature'],
        [HealthDataType.stepsCadenceSeries, 'steps_cadence_series'],
        [HealthDataType.swimmingStrokes, 'swimming_strokes'],
        [
          HealthDataType.walkingAsymmetryPercentage,
