import 'package:health_connector_core/health_connector_core_internal.dart'
    show HealthRecordId, MealType, DietaryPolyunsaturatedFatRecord, sinceV1_1_0;
...
import 'package:health_connector_hk_ios/src/pigeon/health_connector_hk_ios_api.g.dart'
    show DietaryPolyunsaturatedFatRecordDto;
import 'package:meta/meta.dart' show internal;

/// Converts [DietaryPolyunsaturatedFatRecord] to
/// [DietaryPolyunsaturatedFatRecordDto].
@sinceV1_1_0
@internal
extension DietaryPolyunsaturatedFatRecordToDto
    on DietaryPolyunsaturatedFatRecord {
  DietaryPolyunsaturatedFatRecordDto toDto() {
...
/// Converts [DietaryPolyunsaturatedFatRecordDto] to
