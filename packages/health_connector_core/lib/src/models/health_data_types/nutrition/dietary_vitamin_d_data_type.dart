...
final class DietaryVitaminDDataType
    ...
    implements
        ReadableHealthDataType<DietaryVitaminDRecord>,
  ...
  @override
  AggregateRequest<DietaryVitaminDRecord, Mass> aggregateSum({
    required DateTime startTime,
    required DateTime endTime,
  }) {
  ...
  @override
  DeleteRecordsByIdsRequest<DietaryVitaminDRecord> deleteByIds(
  ...
  @override
  DeleteRecordsInTimeRangeRequest<DietaryVitaminDRecord> deleteInTimeRange({
    required DateTime startTime,
    required DateTime endTime,
  }) {
