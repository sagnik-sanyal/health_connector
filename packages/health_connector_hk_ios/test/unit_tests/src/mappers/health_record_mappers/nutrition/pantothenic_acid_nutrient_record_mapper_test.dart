...
void main() {
  group('PantothenicAcidNutrientRecordMapper', () {
    test(
      'toDto converts PantothenicAcidNutrientRecord to '
    ...
    test(
      'toDomain converts PantothenicAcidNutrientRecordDto to '
      'PantothenicAcidNutrientRecord',
      () {
        final dto = PantothenicAcidNutrientRecordDto(
