...
void main() {
  group(
    'PersistentIntermenstrualBleedingEventRecordMapper',
    () {
      group(
        'PersistentIntermenstrualBleedingEventRecordDtoToDomain',
        () {
          test(
            'converts PersistentIntermenstrualBleedingEventRecordDto to '
            'PersistentIntermenstrualBleedingEventRecord',
            () {
              final time = FakeData.fakeTime;

              final dto = PersistentIntermenstrualBleedingEventRecordDto(
                id: FakeData.fakeId,
