...
void main() {
  group(
    'MenstrualFlowRecordMapper',
    () {
      group(
        'MenstrualFlowRecordToDto',
        () {
          test(
            'converts MenstrualFlowRecord to MenstrualFlowRecordDto',
            () {
              ...
              expect(dto.flow, MenstrualFlowDto.medium);
              expect(dto.isCycleStart, true);
      ...
      group(
        'MenstrualFlowRecordDtoToDomain',
        () {
          test(
            'converts MenstrualFlowRecordDto to MenstrualFlowRecord',
            () {
              final dto = MenstrualFlowRecordDto(
                id: FakeData.fakeId,
              ...
              expect(record.flow, MenstrualFlow.heavy);
          ...
          test(
            'converts MenstrualFlowRecordDto with null id to '
            'domain with none id',
            () {
              final dto = MenstrualFlowRecordDto(
                startTime: FakeData.fakeStartTime.millisecondsSinceEpoch,
