...
void main() {
  group(
    'RunningStrideLengthRecordMapper',
    () {
      group(
        'RunningStrideLengthRecordToDto',
        () {
          test(
            'converts RunningStrideLengthRecord to '
            ...
            () {
              final record = RunningStrideLengthRecord(
                ...
                strideLength: const Length.meters(1.2),
              );
      ...
      group(
        'RunningStrideLengthRecordDtoToDomain',
        () {
          test(
            'converts RunningStrideLengthRecordDto to '
            'RunningStrideLengthRecord',
            () {
              final dto = RunningStrideLengthRecordDto(
                id: FakeData.fakeId,
              ...
              expect(record.strideLength.inMeters, 1.5);
              expect(
          ...
          test(
            'converts RunningStrideLengthRecordDto with null id to '
            'domain with none id',
            () {
              final dto = RunningStrideLengthRecordDto(
                startTime: FakeData.fakeStartTime.millisecondsSinceEpoch,
