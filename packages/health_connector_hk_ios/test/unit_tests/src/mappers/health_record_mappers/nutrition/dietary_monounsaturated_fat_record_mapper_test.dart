...
void main() {
  group('DietaryMonounsaturatedFatRecordMapper', () {
    test(
      'toDto converts DietaryMonounsaturatedFatRecord to '
    ...
    test(
      'toDomain converts DietaryMonounsaturatedFatRecordDto to '
      'DietaryMonounsaturatedFatRecord',
      () {
        final dto = DietaryMonounsaturatedFatRecordDto(
