...
void main() {
  group('DietaryTotalFatRecordMapper', () {
    test(
      'toDto converts DietaryTotalFatRecord to DietaryTotalFatRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryTotalFatRecordDto to DietaryTotalFatRecord',
      () {
        final dto = DietaryTotalFatRecordDto(
