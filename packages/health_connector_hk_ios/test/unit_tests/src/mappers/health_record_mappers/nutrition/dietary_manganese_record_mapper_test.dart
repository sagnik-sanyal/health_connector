...
void main() {
  group('DietaryManganeseRecordMapper', () {
    test(
      'toDto converts DietaryManganeseRecord to DietaryManganeseRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryManganeseRecordDto to DietaryManganeseRecord',
      () {
        final dto = DietaryManganeseRecordDto(
