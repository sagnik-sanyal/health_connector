...
/// Generic list tile widget for simple instant health records.
///
/// This widget handles instant health records that follow a simple pattern:
/// - Single icon
/// - Title with formatted value
/// - Standard subtitle (time + recording method)
/// - Detail rows with value label and MeasurementUnitDisplay
///
/// The type parameter [R] should be an instant health record type.
