...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a VitaminCNutrientRecordDto.
    ///
    /// - Returns: VitaminCNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toVitaminCNutrientDto() throws -> VitaminCNutrientRecordDto {
...
extension VitaminCNutrientRecordDto {
