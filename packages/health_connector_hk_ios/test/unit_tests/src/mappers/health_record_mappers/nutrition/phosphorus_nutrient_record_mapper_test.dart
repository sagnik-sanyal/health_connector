...
void main() {
  group('PhosphorusNutrientRecordMapper', () {
    test(
      'toDto converts PhosphorusNutrientRecord to PhosphorusNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts PhosphorusNutrientRecordDto to '
      'PhosphorusNutrientRecord',
      () {
        final dto = PhosphorusNutrientRecordDto(
