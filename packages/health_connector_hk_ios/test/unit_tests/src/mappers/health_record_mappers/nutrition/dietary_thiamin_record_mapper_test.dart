...
void main() {
  group('DietaryThiaminRecordMapper', () {
    test(
      'toDto converts DietaryThiaminRecord to DietaryThiaminRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryThiaminRecordDto to DietaryThiaminRecord',
      () {
        final dto = DietaryThiaminRecordDto(
