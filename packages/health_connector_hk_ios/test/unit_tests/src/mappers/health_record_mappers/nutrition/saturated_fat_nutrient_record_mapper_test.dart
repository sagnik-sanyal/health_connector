...
void main() {
  group('SaturatedFatNutrientRecordMapper', () {
    test(
      'toDto converts SaturatedFatNutrientRecord to '
    ...
    test(
      'toDomain converts SaturatedFatNutrientRecordDto to '
      'SaturatedFatNutrientRecord',
      () {
        final dto = SaturatedFatNutrientRecordDto(
