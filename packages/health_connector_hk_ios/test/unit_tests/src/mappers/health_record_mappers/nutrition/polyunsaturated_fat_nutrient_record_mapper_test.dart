...
void main() {
  group('PolyunsaturatedFatNutrientRecordMapper', () {
    test(
      'toDto converts PolyunsaturatedFatNutrientRecord to '
    ...
    test(
      'toDomain converts PolyunsaturatedFatNutrientRecordDto to '
      'PolyunsaturatedFatNutrientRecord',
      () {
        final dto = PolyunsaturatedFatNutrientRecordDto(
