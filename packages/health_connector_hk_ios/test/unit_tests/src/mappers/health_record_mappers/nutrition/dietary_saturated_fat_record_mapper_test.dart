...
void main() {
  group('DietarySaturatedFatRecordMapper', () {
    test(
      'toDto converts DietarySaturatedFatRecord to '
    ...
    test(
      'toDomain converts DietarySaturatedFatRecordDto to '
      'DietarySaturatedFatRecord',
      () {
        final dto = DietarySaturatedFatRecordDto(
