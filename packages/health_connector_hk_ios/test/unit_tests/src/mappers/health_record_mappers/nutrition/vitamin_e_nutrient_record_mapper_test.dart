...
void main() {
  group('VitaminENutrientRecordMapper', () {
    test(
      'toDto converts VitaminENutrientRecord to VitaminENutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts VitaminENutrientRecordDto to VitaminENutrientRecord',
      () {
        final dto = VitaminENutrientRecordDto(
