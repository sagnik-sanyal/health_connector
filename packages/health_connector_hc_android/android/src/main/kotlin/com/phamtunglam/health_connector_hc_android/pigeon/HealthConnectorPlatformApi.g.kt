// Copyright 2025 Pham Tung Lam. All rights reserved.
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): AggregateResponseDto {
      ...
      val massValue = pigeonVar_list[3] as MassDto?
      return AggregateResponseDto(aggregationMetric, dataType, doubleValue, massValue)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): ReadRecordResponseDto {
      val dataType = pigeonVar_list[0] as HealthDataTypeDto
      val stepsRecord = pigeonVar_list[1] as StepRecordDto?
      val weightRecord = pigeonVar_list[2] as WeightRecordDto?
      return ReadRecordResponseDto(dataType, stepsRecord, weightRecord)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): ReadRecordsResponseDto {
      ...
      return ReadRecordsResponseDto(dataType, nextPageToken, stepsRecords, weightRecords)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WriteRecordRequestDto {
      ...
      val stepsRecord = pigeonVar_list[1] as StepRecordDto?
      val weightRecord = pigeonVar_list[2] as WeightRecordDto?
      return WriteRecordRequestDto(dataType, stepsRecord, weightRecord)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): WriteRecordsRequestDto {
      ...
      val stepsRecords = pigeonVar_list[1] as List<StepRecordDto>?
      val weightRecords = pigeonVar_list[2] as List<WeightRecordDto>?
      return WriteRecordsRequestDto(dataTypes, stepsRecords, weightRecords)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): UpdateRecordRequestDto {
      ...
      val stepsRecord = pigeonVar_list[1] as StepRecordDto?
      val weightRecord = pigeonVar_list[2] as WeightRecordDto?
      return UpdateRecordRequestDto(dataType, stepsRecord, weightRecord)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
