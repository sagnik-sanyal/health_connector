...
void main() {
  group('DietaryCaffeineRecordMapper', () {
    test(
      'toDto converts DietaryCaffeineRecord to DietaryCaffeineRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryCaffeineRecordDto to DietaryCaffeineRecord',
      () {
        final dto = DietaryCaffeineRecordDto(
