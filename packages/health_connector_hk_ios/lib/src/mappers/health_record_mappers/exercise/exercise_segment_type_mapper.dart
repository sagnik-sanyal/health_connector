import 'package:health_connector_core/health_connector_core_internal.dart'
    show ExerciseSessionStateTransitionType, ExerciseSegmentType;
import 'package:health_connector_hk_ios/src/pigeon/health_connector_hk_ios_api.g.dart'
    show ExerciseSessionStateTransitionTypeDto, ExerciseSegmentTypeDto;
import 'package:meta/meta.dart' show internal;

/// Converts [ExerciseSessionStateTransitionType] to
/// [ExerciseSessionStateTransitionTypeDto].
@internal
extension ExerciseSessionStateTransitionTypeToDto
    on ExerciseSessionStateTransitionType {
  ExerciseSessionStateTransitionTypeDto toDto() {
    return switch (this) {
      ExerciseSessionStateTransitionType.pause =>
        ExerciseSessionStateTransitionTypeDto.pause,
      ExerciseSessionStateTransitionType.resume =>
        ExerciseSessionStateTransitionTypeDto.resume,
      ExerciseSessionStateTransitionType.motionPaused =>
        ExerciseSessionStateTransitionTypeDto.motionPaused,
      ExerciseSessionStateTransitionType.motionResumed =>
        ExerciseSessionStateTransitionTypeDto.motionResumed,
      ExerciseSessionStateTransitionType.pauseOrResumeRequest =>
        ExerciseSessionStateTransitionTypeDto.pauseOrResumeRequest,
    };
  }
}

/// Converts [ExerciseSessionStateTransitionTypeDto] to
/// [ExerciseSessionStateTransitionType].
@internal
extension ExerciseSessionStateTransitionTypeDtoToDomain
    on ExerciseSessionStateTransitionTypeDto {
  ExerciseSessionStateTransitionType toDomain() {
    return switch (this) {
      ExerciseSessionStateTransitionTypeDto.pause =>
        ExerciseSessionStateTransitionType.pause,
      ExerciseSessionStateTransitionTypeDto.resume =>
...
/// Converts [ExerciseSegmentType] to [ExerciseSegmentTypeDto].
@internal
...
/// Converts [ExerciseSegmentTypeDto] to [ExerciseSegmentType].
@internal
