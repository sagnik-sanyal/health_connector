...
/// Extension for mapping `HKQuantitySample` → `DietaryVitaminDRecordDto`.
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a DietaryVitaminDRecordDto.
    ///
    /// - Returns: DietaryVitaminDRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toDietaryVitaminDDto() throws -> DietaryVitaminDRecordDto {
...
/// Extension for mapping `DietaryVitaminDRecordDto` → `HKQuantitySample`.
extension DietaryVitaminDRecordDto {
    /// Converts this `DietaryVitaminDRecordDto` to its corresponding `HKQuantitySample`.
    ///
    ...
    func toHKQuantitySample() throws -> HKQuantitySample {
        let quantityType = try HKQuantityType.make(from: .dietaryVitaminD)
