...
void main() {
  group('ZincNutrientRecordMapper', () {
    test('toDto converts ZincNutrientRecord to ZincNutrientRecordDto', () {
    ...
    test('toDomain converts ZincNutrientRecordDto to ZincNutrientRecord', () {
      final dto = ZincNutrientRecordDto(
