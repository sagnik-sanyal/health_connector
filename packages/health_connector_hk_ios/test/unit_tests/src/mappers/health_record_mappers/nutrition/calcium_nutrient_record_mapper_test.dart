...
void main() {
  group('CalciumNutrientRecordMapper', () {
    test(
      'toDto converts CalciumNutrientRecord to CalciumNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts CalciumNutrientRecordDto to CalciumNutrientRecord',
      () {
        final dto = CalciumNutrientRecordDto(
