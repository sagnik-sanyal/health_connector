...
void main() {
  group('DietaryIronRecordMapper', () {
    test('toDto converts DietaryIronRecord to DietaryIronRecordDto', () {
    ...
    test('toDomain converts DietaryIronRecordDto to DietaryIronRecord', () {
      final dto = DietaryIronRecordDto(
