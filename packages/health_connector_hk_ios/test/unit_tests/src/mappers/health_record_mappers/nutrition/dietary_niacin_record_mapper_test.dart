...
void main() {
  group('DietaryNiacinRecordMapper', () {
    test('toDto converts DietaryNiacinRecord to DietaryNiacinRecordDto', () {
    ...
    test(
      'toDomain converts DietaryNiacinRecordDto to DietaryNiacinRecord',
      () {
        final dto = DietaryNiacinRecordDto(
