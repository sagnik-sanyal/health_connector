...
/// Extension for mapping `HKQuantitySample` → `DietaryVitaminERecordDto`.
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a DietaryVitaminERecordDto.
    ///
    /// - Returns: DietaryVitaminERecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toDietaryVitaminEDto() throws -> DietaryVitaminERecordDto {
...
/// Extension for mapping `DietaryVitaminERecordDto` → `HKQuantitySample`.
extension DietaryVitaminERecordDto {
    /// Converts this `DietaryVitaminERecordDto` to its corresponding `HKQuantitySample`.
    ///
