...
import 'package:health_connector_core/src/models/health_records/heart_rate/heart_rate_measurement.dart';
...
part 'energy_burned/active_calories_burned_record.dart';
part 'energy_burned/basal_energy_burned_record.dart';
part 'energy_burned/total_calories_burned_record.dart';
part 'exercise_session_record.dart';
part 'floors_climbed_record.dart';
part 'heart_rate/heart_rate_measurement_record.dart';
...
part 'menstruation/cervical_mucus_record.dart';
part 'menstruation/intermenstrual_bleeding_record.dart';
part 'menstruation/menstrual_flow_instant_record.dart';
part 'menstruation/menstrual_flow_record.dart';
part 'menstruation/menstrual_flow_type.dart';
part 'mindfulness_session_record.dart';
...
part 'sexual_activity_record.dart';
