...
part 'heart_rate/high_heart_rate_event_record.dart';
part 'heart_rate/resting_heart_rate_record.dart';
part 'heart_rate/low_heart_rate_event_record.dart';
part 'heart_rate/irregular_heart_rhythm_event_record.dart';
