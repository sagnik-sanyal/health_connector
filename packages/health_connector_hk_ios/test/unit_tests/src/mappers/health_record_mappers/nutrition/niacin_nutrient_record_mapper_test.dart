...
void main() {
  group('NiacinNutrientRecordMapper', () {
    test('toDto converts NiacinNutrientRecord to NiacinNutrientRecordDto', () {
    ...
    test(
      'toDomain converts NiacinNutrientRecordDto to NiacinNutrientRecord',
      () {
        final dto = NiacinNutrientRecordDto(
