...
void main() {
  group(
    'RunningGroundContactTimeRecordMapper',
    () {
      group(
        'RunningGroundContactTimeRecordToDto',
        () {
          test(
            'converts RunningGroundContactTimeRecord to '
            ...
            () {
              final record = RunningGroundContactTimeRecord(
                ...
                groundContactTime: const TimeDuration.milliseconds(250.0),
              );
      ...
      group(
        'RunningGroundContactTimeRecordDtoToDomain',
        () {
          test(
            'converts RunningGroundContactTimeRecordDto to '
            'RunningGroundContactTimeRecord',
            () {
              final dto = RunningGroundContactTimeRecordDto(
                id: FakeData.fakeId,
              ...
              expect(record.groundContactTime.inSeconds, 0.3);
              expect(
          ...
          test(
            'converts RunningGroundContactTimeRecordDto with null id to '
            'domain with none id',
            () {
              final dto = RunningGroundContactTimeRecordDto(
                startTime: FakeData.fakeStartTime.millisecondsSinceEpoch,
