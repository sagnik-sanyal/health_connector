...
/// Widget for displaying walking heart rate average record tiles.
class WalkingHeartRateAverageRecordListTile extends StatelessWidget {
  const WalkingHeartRateAverageRecordListTile({
    required this.record,
    super.key,
  });

  final WalkingHeartRateAverageRecord record;

  @override
  Widget build(BuildContext context) {
    return IntervalHealthRecordTile<WalkingHeartRateAverageRecord>(
      record: record,
