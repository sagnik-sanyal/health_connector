...
void main() {
  group('LactationRecordMapper', () {
    group('toDto', () {
      test('converts LactationRecord to LactationRecordDto', () {
    ...
    group('toDomain', () {
      test('converts LactationRecordDto to LactationRecord', () {
        final dto = LactationRecordDto(
          id: FakeData.fakeId,
      ...
      test(
        'converts LactationRecordDto with null id to domain with none id',
        () {
          final dto = LactationRecordDto(
            startTime: FakeData.fakeStartTime.millisecondsSinceEpoch,
            endTime: FakeData.fakeEndTime.millisecondsSinceEpoch,
