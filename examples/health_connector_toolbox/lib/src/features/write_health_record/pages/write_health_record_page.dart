...
import 'package:health_connector_toolbox/src/features/write_health_record/pages/write_steps_record_page.dart';
import 'package:health_connector_toolbox/src/features/write_health_record/pages/write_weight_record_page.dart';
    ...
    return Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (_, int index) {
          ...
          return switch (type) {
            StepsHealthDataType() => DataTypeCard(
                ...
                Navigator.push<void>(
                  ...
                  MaterialPageRoute<void>(
                    builder: (_) =>
                        ...
                        >.value(
                          value: context
                              .read<WriteHealthRecordChangeNotifier>(),
                          child: const WriteStepsRecordPage(),
                        ),
                  ),
                );
              },
            ),
            WeightHealthDataType() => DataTypeCard(
              title: type.displayName,
              description: type.description,
              icon: type.icon,
              onTap: () {
                  ...
                  MaterialPageRoute<void>(
                    builder: (_) =>
                        ...
                        >.value(
                          value: context
                              .read<WriteHealthRecordChangeNotifier>(),
                          child: const WriteWeightRecordPage(),
                        ),
                  ),
                );
              },
