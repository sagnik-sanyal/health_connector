...
void main() {
  group('DietaryMagnesiumRecordMapper', () {
    test(
      'toDto converts DietaryMagnesiumRecord to DietaryMagnesiumRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryMagnesiumRecordDto to DietaryMagnesiumRecord',
      () {
        final dto = DietaryMagnesiumRecordDto(
