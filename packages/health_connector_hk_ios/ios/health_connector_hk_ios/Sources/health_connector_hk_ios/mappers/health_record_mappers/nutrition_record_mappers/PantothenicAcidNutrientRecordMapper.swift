...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a PantothenicAcidNutrientRecordDto.
    ///
    /// - Returns: PantothenicAcidNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toPantothenicAcidNutrientDto() throws -> PantothenicAcidNutrientRecordDto {
        guard
...
extension PantothenicAcidNutrientRecordDto {
