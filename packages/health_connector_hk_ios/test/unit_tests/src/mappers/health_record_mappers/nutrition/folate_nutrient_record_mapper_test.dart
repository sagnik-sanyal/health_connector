...
void main() {
  group('FolateNutrientRecordMapper', () {
    test('toDto converts FolateNutrientRecord to FolateNutrientRecordDto', () {
    ...
    test(
      'toDomain converts FolateNutrientRecordDto to FolateNutrientRecord',
      () {
        final dto = FolateNutrientRecordDto(
