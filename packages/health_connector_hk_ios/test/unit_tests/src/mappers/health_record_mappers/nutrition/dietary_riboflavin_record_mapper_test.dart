...
void main() {
  group('DietaryRiboflavinRecordMapper', () {
    test(
      'toDto converts DietaryRiboflavinRecord to DietaryRiboflavinRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryRiboflavinRecordDto to '
      'DietaryRiboflavinRecord',
      () {
        final dto = DietaryRiboflavinRecordDto(
