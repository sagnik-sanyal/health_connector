...
import 'package:health_connector_toolbox/src/features/write_health_record/widgets/device_type_dropdown_field.dart';
import 'package:health_connector_toolbox/src/features/write_health_record/widgets/recording_method_dropdown_field.dart';
...
@immutable
final class MetadataFormFields extends StatefulWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        DeviceTypeDropdownField(
          label: AppTexts.deviceType,
