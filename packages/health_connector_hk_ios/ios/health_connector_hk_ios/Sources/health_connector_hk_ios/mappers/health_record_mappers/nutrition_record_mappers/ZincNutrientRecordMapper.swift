...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a ZincNutrientRecordDto.
    ///
    /// - Returns: ZincNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toZincNutrientDto() throws -> ZincNutrientRecordDto {
...
extension ZincNutrientRecordDto {
