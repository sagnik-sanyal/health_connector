...
void main() {
  group('DietarySugarRecordMapper', () {
    test('toDto converts DietarySugarRecord to DietarySugarRecordDto', () {
    ...
    test('toDomain converts DietarySugarRecordDto to DietarySugarRecord', () {
      final dto = DietarySugarRecordDto(
