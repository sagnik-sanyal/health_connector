...
void main() {
  group('VitaminB12NutrientRecordMapper', () {
    test(
      'toDto converts VitaminB12NutrientRecord to VitaminB12NutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts VitaminB12NutrientRecordDto to '
