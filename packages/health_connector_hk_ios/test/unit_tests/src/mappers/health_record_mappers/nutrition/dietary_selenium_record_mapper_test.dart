...
void main() {
  group('DietarySeleniumRecordMapper', () {
    test(
      'toDto converts DietarySeleniumRecord to DietarySeleniumRecordDto',
      () {
    ...
    test(
      'toDomain converts DietarySeleniumRecordDto to DietarySeleniumRecord',
      () {
        final dto = DietarySeleniumRecordDto(
