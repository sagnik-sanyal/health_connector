...
void main() {
  group('VitaminB6NutrientRecordMapper', () {
    test(
      'toDto converts VitaminB6NutrientRecord to VitaminB6NutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts VitaminB6NutrientRecordDto to VitaminB6NutrientRecord',
      () {
        final dto = VitaminB6NutrientRecordDto(
