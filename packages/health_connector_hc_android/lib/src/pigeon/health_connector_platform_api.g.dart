...
class AggregateResponseDto {
  ...
  static AggregateResponseDto decode(Object result) {
    ...
    return AggregateResponseDto(
      ...
      wheelchairPushesValue: result[7] as NumericDto?,
    );
  }
...
class ReadRecordResponseDto {
  ...
  static ReadRecordResponseDto decode(Object result) {
    ...
    return ReadRecordResponseDto(
      ...
      bodyTemperatureRecord: result[8] as BodyTemperatureRecordDto?,
      wheelchairPushesRecord: result[9] as WheelchairPushesRecordDto?,
    );
  }
...
class ReadRecordsResponseDto {
  ...
  static ReadRecordsResponseDto decode(Object result) {
    ...
    return ReadRecordsResponseDto(
      ...
      bodyFatPercentageRecords: (result[8] as List<Object?>?)?.cast<BodyFatPercentageRecordDto>(),
      bodyTemperatureRecords: (result[9] as List<Object?>?)?.cast<BodyTemperatureRecordDto>(),
      wheelchairPushesRecords: (result[10] as List<Object?>?)?.cast<WheelchairPushesRecordDto>(),
    );
  }
...
class WriteRecordsRequestDto {
  ...
  static WriteRecordsRequestDto decode(Object result) {
    ...
    return WriteRecordsRequestDto(
      ...
      bodyFatPercentageRecords: (result[7] as List<Object?>?)?.cast<BodyFatPercentageRecordDto>(),
      bodyTemperatureRecords: (result[8] as List<Object?>?)?.cast<BodyTemperatureRecordDto>(),
      wheelchairPushesRecords: (result[9] as List<Object?>?)?.cast<WheelchairPushesRecordDto>(),
    );
  }
