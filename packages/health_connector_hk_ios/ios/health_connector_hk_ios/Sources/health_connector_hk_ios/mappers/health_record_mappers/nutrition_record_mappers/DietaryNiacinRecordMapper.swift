...
/// Extension for mapping `HKQuantitySample` → `DietaryNiacinRecordDto`.
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a DietaryNiacinRecordDto.
    ///
    /// - Returns: DietaryNiacinRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toDietaryNiacinDto() throws -> DietaryNiacinRecordDto {
...
/// Extension for mapping `DietaryNiacinRecordDto` → `HKQuantitySample`.
extension DietaryNiacinRecordDto {
    /// Converts this `DietaryNiacinRecordDto` to its corresponding `HKQuantitySample`.
    ///
