...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a VitaminANutrientRecordDto.
    ///
    /// - Returns: VitaminANutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toVitaminANutrientDto() throws -> VitaminANutrientRecordDto {
...
extension VitaminANutrientRecordDto {
