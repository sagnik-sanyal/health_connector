...
void main() {
  group('TotalFatNutrientRecordMapper', () {
    test(
      'toDto converts TotalFatNutrientRecord to TotalFatNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts TotalFatNutrientRecordDto to TotalFatNutrientRecord',
      () {
        final dto = TotalFatNutrientRecordDto(
