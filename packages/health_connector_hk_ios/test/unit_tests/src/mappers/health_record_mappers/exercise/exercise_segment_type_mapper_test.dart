...
void main() {
  group('ExerciseSessionStateTransitionTypeMapper', () {
    parameterizedTest(
      'converts ExerciseSessionStateTransitionType to/from DTO',
      [
        [
      ...
      (
        ExerciseSessionStateTransitionType domain,
        ExerciseSessionStateTransitionTypeDto dto,
      ) {
