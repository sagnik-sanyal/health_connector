...
/// final permissions = [
///   HealthDataType.appleStandTime.readPermission,
/// ];
...
/// final aggRequest = HealthDataType.appleStandTime.aggregateSum(
///   startTime: DateTime.now().subtract(Duration(days: 7)),
///   endTime: DateTime.now(),
/// );
...
@immutable
final class AppleStandTimeDataType
    extends HealthDataType<AppleStandTimeRecord, TimeDuration>
    implements
        ReadableByIdHealthDataType<AppleStandTimeRecord>,
        ReadableInTimeRangeHealthDataType<AppleStandTimeRecord>,
  ...
  bool operator ==(Object other) =>
      ...
      other is AppleStandTimeDataType && runtimeType == other.runtimeType;
  ...
  @override
  ReadRecordByIdRequest<AppleStandTimeRecord> readById(HealthRecordId id) {
    return ReadRecordByIdRequest(dataType: this, id: id);
  }

  @override
  ReadRecordsInTimeRangeRequest<AppleStandTimeRecord> readInTimeRange({
