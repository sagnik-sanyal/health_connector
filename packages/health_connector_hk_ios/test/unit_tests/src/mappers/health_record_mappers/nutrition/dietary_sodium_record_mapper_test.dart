...
void main() {
  group('DietarySodiumRecordMapper', () {
    test('toDto converts DietarySodiumRecord to DietarySodiumRecordDto', () {
    ...
    test(
      'toDomain converts DietarySodiumRecordDto to DietarySodiumRecord',
      () {
        final dto = DietarySodiumRecordDto(
