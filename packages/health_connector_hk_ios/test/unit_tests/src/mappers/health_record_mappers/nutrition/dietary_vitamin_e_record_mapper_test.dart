...
void main() {
  group('DietaryVitaminERecordMapper', () {
    test(
      'toDto converts DietaryVitaminERecord to DietaryVitaminERecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryVitaminERecordDto to DietaryVitaminERecord',
      () {
        final dto = DietaryVitaminERecordDto(
