...
void main() {
  group(
    'RowingDistanceRecordMapper',
    () {
      group(
        'RowingDistanceRecordToDto',
        () {
          test(
          ...
          test(
            'converts RowingDistanceRecord with different distance value',
            () {
              // Given
              final record = RowingDistanceRecord(
                id: HealthRecordId(FakeData.fakeId),
      ...
      group(
        'RowingDistanceRecordDtoToDomain',
        () {
          test(
          ...
          test(
            ...
            () {
              ...
              final dto = DistanceActivityRecordDto(
                ...
                distance: LengthDto(value: 2000.0, unit: LengthUnitDto.meters),
                activityType: DistanceActivityTypeDto.rowing,
              );
