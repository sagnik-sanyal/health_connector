...
void main() {
  group('VitaminANutrientRecordMapper', () {
    test(
      'toDto converts VitaminANutrientRecord to VitaminANutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts VitaminANutrientRecordDto to VitaminANutrientRecord',
      () {
        final dto = VitaminANutrientRecordDto(
