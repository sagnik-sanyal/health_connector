...
/// Widget for displaying inhaler usage record tiles.
final class InhalerUsageTile extends StatelessWidget {
  const InhalerUsageTile({
    required this.record,
    required this.onDelete,
    super.key,
  });

  final InhalerUsageRecord record;
  final VoidCallback onDelete;

  @override
  Widget build(BuildContext context) {
    return IntervalHealthRecordTile<InhalerUsageRecord>(
      record: record,
      icon: AppIcons.medication,
      title: '${record.puffs.value.toStringAsFixed(0)} puffs',
