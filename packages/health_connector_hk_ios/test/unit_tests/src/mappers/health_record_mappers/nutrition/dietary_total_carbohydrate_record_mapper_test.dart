...
void main() {
  group('DietaryTotalCarbohydrateRecordMapper', () {
    test(
      'toDto converts DietaryTotalCarbohydrateRecord to '
    ...
    test(
      'toDomain converts DietaryTotalCarbohydrateRecordDto to '
      'DietaryTotalCarbohydrateRecord',
      () {
        final dto = DietaryTotalCarbohydrateRecordDto(
