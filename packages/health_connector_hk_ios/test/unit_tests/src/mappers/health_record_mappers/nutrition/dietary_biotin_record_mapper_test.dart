...
void main() {
  group('DietaryBiotinRecordMapper', () {
    test('toDto converts DietaryBiotinRecord to DietaryBiotinRecordDto', () {
    ...
    test(
      'toDomain converts DietaryBiotinRecordDto to DietaryBiotinRecord',
      () {
        final dto = DietaryBiotinRecordDto(
