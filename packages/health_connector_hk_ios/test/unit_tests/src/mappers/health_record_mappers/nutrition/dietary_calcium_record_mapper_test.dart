...
void main() {
  group('DietaryCalciumRecordMapper', () {
    test(
      'toDto converts DietaryCalciumRecord to DietaryCalciumRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryCalciumRecordDto to DietaryCalciumRecord',
      () {
        final dto = DietaryCalciumRecordDto(
