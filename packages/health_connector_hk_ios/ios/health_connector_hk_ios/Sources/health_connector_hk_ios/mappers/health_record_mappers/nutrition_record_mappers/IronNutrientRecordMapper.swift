...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to an IronNutrientRecordDto.
    ///
    /// - Returns: IronNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toIronNutrientDto() throws -> IronNutrientRecordDto {
...
extension IronNutrientRecordDto {
