...
void main() {
  group('DietaryVitaminB12RecordMapper', () {
    test(
      'toDto converts DietaryVitaminB12Record to DietaryVitaminB12RecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryVitaminB12RecordDto to '
      'DietaryVitaminB12Record',
      () {
        final dto = DietaryVitaminB12RecordDto(
