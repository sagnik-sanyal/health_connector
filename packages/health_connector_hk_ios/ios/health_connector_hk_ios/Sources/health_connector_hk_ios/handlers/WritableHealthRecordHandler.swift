...
///
/// This protocol provides a default implementation for writing individual health records.
/// Batch write operations are handled atomically at the `HealthConnectorClient` level
/// to ensure all-or-nothing semantics across different record types.
