...
public enum HealthDataTypeDto: Int {
  ...
  case intermenstrualBleeding = 74
  /// Menstrual flow data (iOS HealthKit only).
  case menstrualFlow = 75
  /// Oxygen saturation data.
  case oxygenSaturation = 76
  /// Respiratory rate data.
  case respiratoryRate = 77
  /// VO2 max (maximal oxygen uptake) data.
  case vo2Max = 78
  /// Blood glucose data.
  case bloodGlucose = 79
  /// Exercise session data.
  case exerciseSession = 80
  /// Mindfulness session data.
  case mindfulnessSession = 81
  /// Body mass index data.
  case bodyMassIndex = 82
  /// Waist circumference data.
  case waistCircumference = 83
  /// Heart rate variability (SDNN) data.
  case heartRateVariabilitySDNN = 84
}
