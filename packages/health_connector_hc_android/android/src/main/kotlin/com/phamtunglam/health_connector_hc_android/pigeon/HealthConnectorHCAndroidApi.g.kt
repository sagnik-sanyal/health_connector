...
enum class HealthDataTypeDto(val raw: Int) {
  ...
  INTERMENSTRUAL_BLEEDING(23),
  /** Menstrual flow instant data (Android Health Connect). */
  MENSTRUAL_FLOW_INSTANT(24),
