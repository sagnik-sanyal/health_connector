...
enum class TimeDurationUnitDto(val raw: Int) {
  SECONDS(0),
  MINUTES(1),
  HOURS(2);

  companion object {
    fun ofRaw(raw: Int): TimeDurationUnitDto? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}
...
) : MeasurementUnitDto()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): TimeDurationDto {
      val unit = pigeonVar_list[0] as TimeDurationUnitDto
      val value = pigeonVar_list[1] as Double
      return TimeDurationDto(unit, value)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
) : HealthRecordDto()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): RestingHeartRateRecordDto {
      ...
      val time = pigeonVar_list[1] as Long
      val metadata = pigeonVar_list[2] as MetadataDto
      val beatsPerMinute = pigeonVar_list[3] as NumberDto
...
) : HealthRecordDto()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): RespiratoryRateRecordDto {
      ...
      val time = pigeonVar_list[1] as Long
      val metadata = pigeonVar_list[2] as MetadataDto
      val breathsPerMin = pigeonVar_list[3] as NumberDto
      val zoneOffsetSeconds = pigeonVar_list[4] as Long?
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): HeartRateMeasurementDto {
      ...
      val beatsPerMinute = pigeonVar_list[1] as NumberDto
...
private open class HealthConnectorHCAndroidApiPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      133.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
          TimeDurationUnitDto.ofRaw(it.toInt())
        }
      }
      134.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
