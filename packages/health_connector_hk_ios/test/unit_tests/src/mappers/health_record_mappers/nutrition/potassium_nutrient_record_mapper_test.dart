...
void main() {
  group('PotassiumNutrientRecordMapper', () {
    test(
      'toDto converts PotassiumNutrientRecord to PotassiumNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts PotassiumNutrientRecordDto to PotassiumNutrientRecord',
      () {
        final dto = PotassiumNutrientRecordDto(
