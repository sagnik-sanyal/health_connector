...
void main() {
  group('VitaminKNutrientRecordMapper', () {
    test(
      'toDto converts VitaminKNutrientRecord to VitaminKNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts VitaminKNutrientRecordDto to VitaminKNutrientRecord',
      () {
        final dto = VitaminKNutrientRecordDto(
