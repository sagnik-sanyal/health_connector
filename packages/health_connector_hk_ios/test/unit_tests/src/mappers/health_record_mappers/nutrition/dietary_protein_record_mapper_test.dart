...
void main() {
  group('DietaryProteinRecordMapper', () {
    test(
      'toDto converts DietaryProteinRecord to DietaryProteinRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryProteinRecordDto to DietaryProteinRecord',
      () {
        final dto = DietaryProteinRecordDto(
