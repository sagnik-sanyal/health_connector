...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a MonounsaturatedFatNutrientRecordDto.
    ///
    /// - Returns: MonounsaturatedFatNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toMonounsaturatedFatNutrientDto() throws -> MonounsaturatedFatNutrientRecordDto {
        guard
...
extension MonounsaturatedFatNutrientRecordDto {
