...
/// Widget for displaying pregnancy test record tiles.
final class PregnancyTestListTile extends StatelessWidget {
  const PregnancyTestListTile({
    required this.record,
    required this.onDelete,
    super.key,
  });

  final PregnancyTestRecord record;
  ...
  Widget build(BuildContext context) {
    ...
    return InstantHealthRecordTile<PregnancyTestRecord>(
      record: record,
      icon: AppIcons.science,
      title: AppTexts.pregnancyTest,
