...
void main() {
  group('ThiaminNutrientRecordMapper', () {
    test(
      'toDto converts ThiaminNutrientRecord to ThiaminNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts ThiaminNutrientRecordDto to ThiaminNutrientRecord',
      () {
        final dto = ThiaminNutrientRecordDto(
