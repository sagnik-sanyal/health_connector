...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a CalciumNutrientRecordDto.
    ///
    /// - Returns: CalciumNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toCalciumNutrientDto() throws -> CalciumNutrientRecordDto {
...
extension CalciumNutrientRecordDto {
