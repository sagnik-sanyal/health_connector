...
void main() {
  group('SeleniumNutrientRecordMapper', () {
    test(
      'toDto converts SeleniumNutrientRecord to SeleniumNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts SeleniumNutrientRecordDto to SeleniumNutrientRecord',
      () {
        final dto = SeleniumNutrientRecordDto(
