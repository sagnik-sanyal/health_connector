...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a CaffeineNutrientRecordDto.
    ///
    /// - Returns: CaffeineNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toCaffeineNutrientDto() throws -> CaffeineNutrientRecordDto {
...
extension CaffeineNutrientRecordDto {
