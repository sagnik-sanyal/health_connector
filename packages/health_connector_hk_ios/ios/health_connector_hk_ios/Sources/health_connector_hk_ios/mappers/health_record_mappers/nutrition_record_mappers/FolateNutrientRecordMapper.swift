...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a FolateNutrientRecordDto.
    ///
    /// - Returns: FolateNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toFolateNutrientDto() throws -> FolateNutrientRecordDto {
...
extension FolateNutrientRecordDto {
