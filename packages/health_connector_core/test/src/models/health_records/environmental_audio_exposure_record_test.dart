...
void main() {
  group('EnvironmentalAudioExposureRecord', () {
    final now = DateTime(2026, 1, 22);
    final endTime = now.add(const Duration(minutes: 10));
    final metadata = Metadata.manualEntry();
    const decibel = Number(65.0);

    test('can be instantiated with valid parameters', () {
      final record = EnvironmentalAudioExposureRecord(
        startTime: now,
        endTime: endTime,
    ...
    test('equality works correctly', () {
      final record1 = EnvironmentalAudioExposureRecord(
        startTime: now,
        endTime: endTime,
        aWeightedDecibel: decibel,
        metadata: metadata,
      );
      final record2 = EnvironmentalAudioExposureRecord(
        startTime: now,
        endTime: endTime,
        aWeightedDecibel: decibel,
        metadata: metadata,
      ...
      final record3 = EnvironmentalAudioExposureRecord(
        startTime: now,
        endTime: endTime,
        aWeightedDecibel: const Number(70.0),
        metadata: metadata,
      );
