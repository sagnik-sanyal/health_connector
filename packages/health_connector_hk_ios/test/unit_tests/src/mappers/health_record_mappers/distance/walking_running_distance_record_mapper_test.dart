...
void main() {
  group(
    'WalkingRunningDistanceRecordMapper',
    () {
      group(
        'WalkingRunningDistanceRecordToDto',
        () {
          test(
            'converts WalkingRunningDistanceRecord to '
          ...
          test(
            'converts WalkingRunningDistanceRecord with different distance '
            'value',
            () {
              // Given
              final record = WalkingRunningDistanceRecord(
      ...
      group(
        'WalkingRunningDistanceRecordDtoToDomain',
        () {
          test(
          ...
          test(
            ...
            () {
              ...
              final dto = DistanceActivityRecordDto(
                ...
                distance: LengthDto(value: 4200.0, unit: LengthUnitDto.meters),
                activityType: DistanceActivityTypeDto.walkingRunning,
              );
              ...
              // Then
              expect(record.distance.inMeters, 4200.0);
            },
          );
        },
      );
