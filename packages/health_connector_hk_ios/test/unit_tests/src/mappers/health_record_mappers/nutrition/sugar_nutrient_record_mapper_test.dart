...
void main() {
  group('SugarNutrientRecordMapper', () {
    test('toDto converts SugarNutrientRecord to SugarNutrientRecordDto', () {
    ...
    test('toDomain converts SugarNutrientRecordDto to SugarNutrientRecord', () {
      final dto = SugarNutrientRecordDto(
