...
import 'package:health_connector_toolbox/src/features/read_health_records/widgets/sleep_session_record_sleep_stages_list.dart';

/// Widget for displaying sleep session record tiles.
final class SleepSessionTile extends StatelessWidget {
  const SleepSessionTile({
  ...
  Widget build(BuildContext context) {
    return SeriesHealthRecordTile<SleepSessionRecord, SleepStage>(
      ...
      samplesBuilder: (samples, ctx) =>
          SleepSessionRecordSleepStagesList(stages: samples),
      onDelete: onDelete,
    );
  }
}
