import 'package:health_connector_core/health_connector_core_internal.dart'
    show DietaryManganeseRecord, HealthRecordId, Mass, MealType, sinceV1_1_0;
...
import 'package:health_connector_hk_ios/src/pigeon/health_connector_hk_ios_api.g.dart'
    show DietaryManganeseRecordDto;
import 'package:meta/meta.dart' show internal;

/// Converts [DietaryManganeseRecord] to [DietaryManganeseRecordDto].
@sinceV1_1_0
@internal
extension DietaryManganeseRecordToDto on DietaryManganeseRecord {
  DietaryManganeseRecordDto toDto() {
...
/// Converts [DietaryManganeseRecordDto] to [DietaryManganeseRecord].
@sinceV1_1_0
@internal
