...
void main() {
  group('DietaryVitaminDRecordMapper', () {
    test(
      'toDto converts DietaryVitaminDRecord to DietaryVitaminDRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryVitaminDRecordDto to DietaryVitaminDRecord',
      () {
        final dto = DietaryVitaminDRecordDto(
