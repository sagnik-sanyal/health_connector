...
void main() {
  group('DietaryVitaminARecordMapper', () {
    test(
      'toDto converts DietaryVitaminARecord to DietaryVitaminARecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryVitaminARecordDto to DietaryVitaminARecord',
      () {
        final dto = DietaryVitaminARecordDto(
