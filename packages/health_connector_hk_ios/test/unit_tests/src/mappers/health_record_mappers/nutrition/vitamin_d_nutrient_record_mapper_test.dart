...
void main() {
  group('VitaminDNutrientRecordMapper', () {
    test(
      'toDto converts VitaminDNutrientRecord to VitaminDNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts VitaminDNutrientRecordDto to VitaminDNutrientRecord',
      () {
        final dto = VitaminDNutrientRecordDto(
