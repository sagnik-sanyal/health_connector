...
void main() {
  group('CaffeineNutrientRecordMapper', () {
    test(
      'toDto converts CaffeineNutrientRecord to CaffeineNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts CaffeineNutrientRecordDto to CaffeineNutrientRecord',
      () {
        final dto = CaffeineNutrientRecordDto(
