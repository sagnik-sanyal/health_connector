...
void main() {
  group('MagnesiumNutrientRecordMapper', () {
    test(
      'toDto converts MagnesiumNutrientRecord to MagnesiumNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts MagnesiumNutrientRecordDto to MagnesiumNutrientRecord',
      () {
        final dto = MagnesiumNutrientRecordDto(
