...
/// Widget for displaying walking asymmetry percentage record tiles.
final class WalkingAsymmetryPercentageRecordListTile extends StatelessWidget {
  const WalkingAsymmetryPercentageRecordListTile({
    required this.record,
    required this.onDelete,
    super.key,
  });

  final WalkingAsymmetryPercentageRecord record;
  final VoidCallback onDelete;

  @override
  Widget build(BuildContext context) {
    return IntervalHealthRecordTile<WalkingAsymmetryPercentageRecord>(
      record: record,
      icon: AppIcons.directionsWalk,
      title: AppTexts.walkingAsymmetryPercentage,
