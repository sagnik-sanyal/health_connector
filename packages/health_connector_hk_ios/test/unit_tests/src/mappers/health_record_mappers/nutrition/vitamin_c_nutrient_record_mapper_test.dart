...
void main() {
  group('VitaminCNutrientRecordMapper', () {
    test(
      'toDto converts VitaminCNutrientRecord to VitaminCNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts VitaminCNutrientRecordDto to VitaminCNutrientRecord',
      () {
        final dto = VitaminCNutrientRecordDto(
