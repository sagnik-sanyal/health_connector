...
void main() {
  group(
    'DownhillSnowSportsDistanceRecordMapper',
    () {
      group(
        'DownhillSnowSportsDistanceRecordToDto',
        () {
          test(
            'converts DownhillSnowSportsDistanceRecord to '
          ...
          test(
            'converts DownhillSnowSportsDistanceRecord with different '
            'distance value',
            () {
              // Given
              final record = DownhillSnowSportsDistanceRecord(
      ...
      group(
        'DownhillSnowSportsDistanceRecordDtoToDomain',
        () {
          test(
          ...
          test(
            ...
            () {
              ...
              final dto = DistanceActivityRecordDto(
                ...
                distance: LengthDto(value: 4000.0, unit: LengthUnitDto.meters),
                activityType: DistanceActivityTypeDto.downhillSnowSports,
              );
              ...
              expect(record.distance.inMeters, 4000.0);
            },
          );
          ...
          test(
            ...
            () {
              ...
              final dto = DistanceActivityRecordDto(
                ...
                distance: LengthDto(value: 1200.0, unit: LengthUnitDto.meters),
                activityType: DistanceActivityTypeDto.downhillSnowSports,
              );
              ...
              // Then
              expect(record.distance.inMeters, 1200.0);
            },
          );
        },
      );
