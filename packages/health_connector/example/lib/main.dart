...
class _ExampleAppHomePageState extends State<ExampleAppHomePage> {
  ...
  Future<void> _updateRecord() async {
    ...
    try {
      ...
      final updatedRecordId = await _connector!.updateRecord(updatedRecord);
  ...
  Future<void> _deleteRecords() async {
    ...
    try {
      ...
      await _connector!.deleteRecords(
  ...
  /// Demonstrates [HealthConnector.deleteRecordsByIds] method.
  ///
  ...
  Future<void> _deleteRecordsByIds() async {
    ...
    try {
      ...
      await _connector!.deleteRecordsByIds(
        dataType: HealthDataType.steps,
        recordIds: recordIds,
      );
