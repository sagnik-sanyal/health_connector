...
abstract final class AppTexts {
  ...
  static String getLabel(HealthDataType type) {
    return switch (type) {
      ...
      TotalFatNutrientDataType() => totalFat,
      SaturatedFatNutrientDataType() => saturatedFat,
      MonounsaturatedFatNutrientDataType() => monounsaturatedFat,
      PolyunsaturatedFatNutrientDataType() => polyunsaturatedFat,
      CholesterolNutrientDataType() => cholesterol,
      DietaryFiberNutrientDataType() => dietaryFiber,
      SugarNutrientDataType() => sugar,
      CalciumNutrientDataType() => calcium,
      IronNutrientDataType() => iron,
      MagnesiumNutrientDataType() => magnesium,
      ManganeseNutrientDataType() => manganese,
      PhosphorusNutrientDataType() => phosphorus,
      PotassiumNutrientDataType() => potassium,
      SeleniumNutrientDataType() => selenium,
      SodiumNutrientDataType() => sodium,
      ZincNutrientDataType() => zinc,
      VitaminANutrientDataType() => vitaminA,
      VitaminB6NutrientDataType() => vitaminB6,
      VitaminB12NutrientDataType() => vitaminB12,
      VitaminCNutrientDataType() => vitaminC,
      VitaminDNutrientDataType() => vitaminD,
      VitaminENutrientDataType() => vitaminE,
      VitaminKNutrientDataType() => vitaminK,
      ThiaminNutrientDataType() => thiamin,
      RiboflavinNutrientDataType() => riboflavin,
      NiacinNutrientDataType() => niacin,
