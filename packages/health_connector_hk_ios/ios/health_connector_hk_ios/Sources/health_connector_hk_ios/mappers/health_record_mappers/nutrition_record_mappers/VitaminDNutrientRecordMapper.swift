...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a VitaminDNutrientRecordDto.
    ///
    /// - Returns: VitaminDNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toVitaminDNutrientDto() throws -> VitaminDNutrientRecordDto {
...
extension VitaminDNutrientRecordDto {
