...
void main() {
  group('ProteinNutrientRecordMapper', () {
    test(
      'toDto converts ProteinNutrientRecord to ProteinNutrientRecordDto',
      () {
    ...
    test(
      'toDomain converts ProteinNutrientRecordDto to ProteinNutrientRecord',
      () {
        final dto = ProteinNutrientRecordDto(
