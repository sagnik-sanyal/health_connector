...
extension HKQuantitySample {
    /// Converts this HealthKit quantity sample to a DietaryFiberNutrientRecordDto.
    ///
    /// - Returns: DietaryFiberNutrientRecordDto
    /// - Throws: `HealthConnectorError.invalidArgument` if quantity type mismatch
    func toDietaryFiberNutrientDto() throws -> DietaryFiberNutrientRecordDto {
...
extension DietaryFiberNutrientRecordDto {
