...
void main() {
  group('DietaryVitaminCRecordMapper', () {
    test(
      'toDto converts DietaryVitaminCRecord to DietaryVitaminCRecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryVitaminCRecordDto to DietaryVitaminCRecord',
      () {
        final dto = DietaryVitaminCRecordDto(
