...
/// Widget for displaying systolic blood pressure record tiles.
@immutable
final class SystolicBloodPressureTile extends StatelessWidget {
  const SystolicBloodPressureTile({
    required this.record,
    required this.onDelete,
    super.key,
  });

  final SystolicBloodPressureRecord record;
