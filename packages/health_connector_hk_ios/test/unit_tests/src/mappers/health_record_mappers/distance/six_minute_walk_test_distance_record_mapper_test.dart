...
void main() {
  group(
    'SixMinuteWalkTestDistanceRecordMapper',
    () {
      group(
        'SixMinuteWalkTestDistanceRecordToDto',
        () {
          test(
            'converts SixMinuteWalkTestDistanceRecord to '
          ...
          test(
            'converts SixMinuteWalkTestDistanceRecord with different '
            'distance value',
            () {
              // Given
              final record = SixMinuteWalkTestDistanceRecord(
              ...
              // Then
              expect(dto.distance.value, 600.0);
              expect(
                dto.activityType,
                DistanceActivityTypeDto.sixMinuteWalkTest,
              );
      ...
      group(
        'SixMinuteWalkTestDistanceRecordDtoToDomain',
        () {
          test(
          ...
          test(
            ...
            () {
              ...
              final dto = DistanceActivityRecordDto(
                ...
                distance: LengthDto(value: 550.0, unit: LengthUnitDto.meters),
                activityType: DistanceActivityTypeDto.sixMinuteWalkTest,
              );
              ...
              expect(record.distance.inMeters, 550.0);
            },
          );
          ...
          test(
            ...
            () {
              ...
              final dto = DistanceActivityRecordDto(
                ...
                distance: LengthDto(value: 380.0, unit: LengthUnitDto.meters),
                activityType: DistanceActivityTypeDto.sixMinuteWalkTest,
              );
              ...
              // Then
              expect(record.distance.inMeters, 380.0);
            },
          );
        },
      );
