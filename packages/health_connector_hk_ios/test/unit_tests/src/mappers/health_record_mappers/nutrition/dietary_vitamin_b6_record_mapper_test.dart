...
void main() {
  group('DietaryVitaminB6RecordMapper', () {
    test(
      'toDto converts DietaryVitaminB6Record to DietaryVitaminB6RecordDto',
      () {
    ...
    test(
      'toDomain converts DietaryVitaminB6RecordDto to DietaryVitaminB6Record',
      () {
        final dto = DietaryVitaminB6RecordDto(
